...
ViridianCity_Object:
	...
	warp_event 31, 25, VIRIDIAN_MART, 1
	warp_event 23, 15, VIRIDIAN_SCHOOL_HOUSE, 1
	warp_event 31, 15, VIRIDIAN_NICKNAME_HOUSE, 1
	warp_event 32,  7, VIRIDIAN_GYM, 1

	def_bg_events
	bg_event 27, 21, TEXT_VIRIDIANCITY_SIGN
	bg_event 30, 26, TEXT_VIRIDIANCITY_TRAINER_TIPS1
	bg_event 22, 26, TEXT_VIRIDIANCITY_TRAINER_TIPS2
	bg_event 32, 25, TEXT_VIRIDIANCITY_MART_SIGN
	bg_event 24, 25, TEXT_VIRIDIANCITY_POKECENTER_SIGN
	bg_event 27,  7, TEXT_VIRIDIANCITY_GYM_SIGN

	def_object_events
	object_event 17, 20, SPRITE_YOUNGSTER, WALK, ANY_DIR, TEXT_VIRIDIANCITY_YOUNGSTER1
