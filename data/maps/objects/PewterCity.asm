...
PewterCity_Object:
	...
	def_bg_events
	bg_event 19, 21, TEXT_PEWTERCITY_TRAINER_TIPS
	bg_event 33, 13, TEXT_PEWTERCITY_POLICE_NOTICE_SIGN
	...
	bg_event  9, 17, TEXT_PEWTERCITY_GYM_SIGN
	bg_event 24, 26, TEXT_PEWTERCITY_SIGN

	def_object_events
	object_event  6, 15, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_PEWTERCITY_COOLTRAINER_F
	...
	object_event 28, 27, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_PEWTERCITY_SUPER_NERD2
