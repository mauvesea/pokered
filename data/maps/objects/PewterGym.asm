...
PewterGym_Object:
	...
	object_event  3,  5, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_PEWTERGYM_COOLTRAINER_M, OPP_JR_TRAINER_M, 1
	object_event  6,  7, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_PEWTERGYM_YOUNGSTER, OPP_YOUNGSTER, 1
